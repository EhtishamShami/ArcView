...
public class ColorArcProgressBar extends View {
    ...
    private float sweepAngle = 243;
    private float currentAngle = 0;
    private float lastAngle;
    private int[] colors = new int[]{R.color.arccolor1, R.color.arccolor1, R.color.arccolor2, R.color.arccolor2};
    ...
    private final int DEGREE_PROGRESS_DISTANCE = dipToPx(6);
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        int color1 = a.getColor(R.styleable.ColorArcProgressBar_front_color1, getResources().getColor(R.color.arccolor1));
        int color2 = a.getColor(R.styleable.ColorArcProgressBar_front_color2, getResources().getColor(R.color.arccolor1));
        int color3 = a.getColor(R.styleable.ColorArcProgressBar_front_color3, getResources().getColor(R.color.arccolor2));
        colors = new int[]{color1, color2, color3, color3};

        sweepAngle = a.getInteger(R.styleable.ColorArcProgressBar_total_engle, 243);
    ...
    protected void onDraw(Canvas canvas) {
            ...
            for (int i = 0; i < 40; i++) {
                ...
                if (i % 5 == 0) {
                    ...
                    canvas.drawLine(centerX, centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE,
                            centerX, centerY - diameter / 2 - progressWidth / 2 - DEGREE_PROGRESS_DISTANCE - (longdegree - shortdegree) / 2, degreePaint);
                } else {
                    degreePaint.setStrokeWidth(dipToPx(2));
        ...
        //整个弧
        canvas.drawArc(bgRect, startAngle, 243, false, allArcPaint);
    ...
    private int dipToPx(float dip) {
        ...
        return (int) (dip * density + 0.3f * (dip >= 0 ? 1 : -1));
    }
